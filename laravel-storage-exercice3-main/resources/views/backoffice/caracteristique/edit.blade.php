        ...
        <form method="POST" action="/caracteristiques/{{ $caracteristique->id }}" enctype="multipart/form-data">
            ...
            <div class="mb-3">
              ...
              <select class="form-control fw-bold" name="icone">
                    ...
                    <option value="fa-taxi" {{ $caracteristique->icone === 'fa-address-book' ? 'selected' : '' }}> Taxi</option>
                    <option value="fa-hospital" {{ $caracteristique->icone === 'fa-address-book' ? 'selected' : '' }}> Hopital</option>
                    <option value="fa-cut" {{ $caracteristique->icone === 'fa-address-book' ? 'selected' : '' }}> Coiffeur</option>
                    <option value="fa-fire-extinguisher" {{ $caracteristique->icone === 'fa-address-book' ? 'selected' : '' }}> Pompier</option>
              </select>
